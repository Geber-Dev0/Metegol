...
<body>
  ...
  <script>
    ...
    // URL base del manifest (configurable): instalar desde aca hace que Stremio
    // muestre la configuracion (tuerca verde) y aplique la zona horaria elegida.
    function baseManifestUrl() {
      return window.location.protocol + '//' + window.location.host + manifestPath
    }
